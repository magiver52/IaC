...
module "RDS" {
  ...
  subnet_db   = module.vpc.private_subnet_ids
  vpcidout    = module.vpc.vpc_id
  sg_rds      = module.sg_rds.security_group_id
  depends_on = [module.vpc, module.sg_rds]
}
